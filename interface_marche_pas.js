...
function createTextureChemin (centres, chemin, w, h, repeatX, repeatY) {
    ...
    caillou1 = document.getElementById('1');

    wc = caillou1.width;
    hc = caillou1.height;

    caillou1.onload = FaireCanvasChemin(repeatX,repeatY, ctx,w,h);

    function FaireCanvasChemin(repeatX,repeatY, ctxchemin,w,h) {

        for (let i = 0; i < repeatX; i++) {
            for (let j = 0; j < repeatY; j++) {
                ctxchemin.drawImage(caillou1, 0,0, wc, hc, w * i, j * h, w, h);
...
function dupliquer(centres, Xrepeat, Yrepeat, w, h) {
    ...
    for (let k = 0; k < centres.length; k++) {
        var x = centresTexture12[k][0];
        var y = centresTexture12[k][1];
...
function init_textures() {
    ...
    //textureMask = defineTexture("graphics/masque_freeTexture12.png", 10, 10, true)
    ...
    var centres = dupliquer(centresTexture12, 10, 10, w1, h1);
    ...
    */
    ...
    var centres = dupliquer(centresTexture12, 10, 10, herbetext.width/2, herbetext.height/4);

    console.log("createTextureChemin")

    //caillou1 = document.getElementById('1');
    var canvascaillou = createTextureChemin(centres, chemin, herbetext.width/2, herbetext.height/4, 10, 10);

    var textureChemin = defineTextureCanvas(canvascaillou, 0, 0, false);
    textureChemin.minFilter = THREE.LinearFilter;

    ///////////////////////////////////////////////////
    //////////////////////////////////////////////////////////////////////////////////////////
    materialRock5 = new THREE.MeshBasicMaterial({map: textureChemin, side: THREE.DoubleSide, wireframe: wireframe_mode, shininess: 0 });
